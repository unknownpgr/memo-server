...
const models: TsoaRoute.Models = {
    ...
    "MemoSummary": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"updatedAt":{"dataType":"string","required":true},"createdAt":{"dataType":"string","required":true},"title":{"dataType":"string","required":true},"parentId":{"dataType":"double","required":true},"id":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(router: KoaRouter) {
    ...
    // ###########################################################################################################
        router.post('/api/login',
            ...
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.login)),

            async function MemoController_login(context: any, next: any) {
            const args = {
                    undefined: {"in":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"password":{"dataType":"string","required":true}}},
            };
        ...
        router.delete('/api/logout',
            ...(fetchMiddlewares<Middleware>(MemoController)),
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.logout)),

            async function MemoController_logout(context: any, next: any) {
            const args = {
        ...
        router.get('/api/memo/:memoId',
            ...
            const promise = controller.findMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.get('/api/memo',
            ...(fetchMiddlewares<Middleware>(MemoController)),
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.listMemo)),

            async function MemoController_listMemo(context: any, next: any) {
            const args = {
                    token: {"in":"header","name":"authorization","required":true,"dataType":"string"},
            };
            ...
            const promise = controller.listMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.post('/api/memo',
            ...(fetchMiddlewares<Middleware>(MemoController)),
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.createMemo)),
            ...
            const promise = controller.createMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.put('/api/memo/:memoId',
            ...
            const promise = controller.updateMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.delete('/api/memo/:memoId',
            ...
            const promise = controller.deleteMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.get('/api/backup',
            ...(fetchMiddlewares<Middleware>(MemoController)),
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.listBackups)),

            async function MemoController_listBackups(context: any, next: any) {
            const args = {
                    token: {"in":"header","name":"authorization","required":true,"dataType":"string"},
            };
            ...
            const promise = controller.listBackups.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.post('/api/backup',
            ...(fetchMiddlewares<Middleware>(MemoController)),
            ...(fetchMiddlewares<Middleware>(MemoController.prototype.backupMemo)),

            async function MemoController_backupMemo(context: any, next: any) {
            const args = {
                    token: {"in":"header","name":"authorization","required":true,"dataType":"string"},
            };
            ...
            const promise = controller.backupMemo.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, undefined);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
